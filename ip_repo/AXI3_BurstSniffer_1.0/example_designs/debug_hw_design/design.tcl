...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AXI3_BurstSniffer_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI3_BurstSniffer_0/S_AXIL]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/s_axil_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/s_axil_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins AXI3_BurstSniffer_0/SLOT_0]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_0_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_0_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins AXI3_BurstSniffer_0/SLOT_1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_1_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_1_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M03_AXI] [get_bd_intf_pins AXI3_BurstSniffer_0/SLOT_2]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_2_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_2_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M04_AXI] [get_bd_intf_pins AXI3_BurstSniffer_0/SLOT_3]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_3_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI3_BurstSniffer_0/slot_3_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AXI3_BurstSniffer_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI3_BurstSniffer_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI3_BurstSniffer_0_S_AXIL_* ]]
	puts $fp "set s_axil_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI3_BurstSniffer_0_SLOT_0_* ]]
	puts $fp "set slot_0_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI3_BurstSniffer_0_SLOT_1_* ]]
	puts $fp "set slot_1_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI3_BurstSniffer_0_SLOT_2_* ]]
	puts $fp "set slot_2_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI3_BurstSniffer_0_SLOT_3_* ]]
	puts $fp "set slot_3_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI3_BurstSniffer_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI3_BurstSniffer_v1_0_hw_${i}"
