...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AXI4_Masters_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI4_Masters_0/S_AXIL]
	connect_bd_net [get_bd_pins AXI4_Masters_0/s_axil_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Masters_0/s_axil_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of AXI4_Masters_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins AXI4_Masters_0/M_AXIL]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axil_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axil_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axil_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axil_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axil_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins AXI4_Masters_0/M_AXIF]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axif_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axif_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axif_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axif_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axif_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]

	# Connect all clock & reset of AXI4_Masters_0 streaming interfaces..
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Masters_0/m_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of AXI4_Masters_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AXI4_Masters_0/M_AXIL/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AXI4_Masters_0/M_AXIF/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXIL_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M_AXIF_TARGET_SLAVE_BASE_ADDR {0xC0000100} ] [get_bd_cells AXI4_Masters_0]

	# Copy all address to AXI4_Masters_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI4_Masters_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI4_Masters_0_S_AXIL_* ]]
	puts $fp "set s_axil_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI4_Masters_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI4_Masters_v1_0_hw_${i}"
