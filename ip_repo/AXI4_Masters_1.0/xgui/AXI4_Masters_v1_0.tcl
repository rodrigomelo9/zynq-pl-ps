...
proc init_gui { IPINST } {
  ...
  set C_M_AXIF_BUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_BUSER_WIDTH"]
  set_property tooltip {Width of User Response Bus} ${C_M_AXIF_BUSER_WIDTH}
  set C_M_AXIF_RUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_RUSER_WIDTH"]
  set_property tooltip {Width of User Read Data Bus} ${C_M_AXIF_RUSER_WIDTH}
  set C_M_AXIF_WUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_WUSER_WIDTH"]
  set_property tooltip {Width of User Write Data Bus} ${C_M_AXIF_WUSER_WIDTH}
  set C_M_AXIF_ARUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_ARUSER_WIDTH"]
  set_property tooltip {Width of User Read Address Bus} ${C_M_AXIF_ARUSER_WIDTH}
  set C_M_AXIF_AWUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_AWUSER_WIDTH"]
  set_property tooltip {Width of User Write Address Bus} ${C_M_AXIF_AWUSER_WIDTH}
  set C_M_AXIF_DATA_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_DATA_WIDTH" -widget comboBox]
  set_property tooltip {Width of Data Bus} ${C_M_AXIF_DATA_WIDTH}
  set C_M_AXIF_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_ADDR_WIDTH"]
  set_property tooltip {Width of Address Bus} ${C_M_AXIF_ADDR_WIDTH}
  set C_M_AXIF_ID_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIF_ID_WIDTH"]
  set_property tooltip {Thread ID Width} ${C_M_AXIF_ID_WIDTH}
  set C_M_AXIL_DATA_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIL_DATA_WIDTH" -widget comboBox]
  set_property tooltip {Width of M_AXI data bus. 
    -- The master issues write data and accept read data where the width of the data bus is C_M_AXI_DATA_WIDTH} ${C_M_AXIL_DATA_WIDTH}
  set C_M_AXIL_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M_AXIL_ADDR_WIDTH"]
  set_property tooltip {Width of M_AXI address bus. 
    -- The master generates the read and write addresses of width specified as C_M_AXI_ADDR_WIDTH.} ${C_M_AXIL_ADDR_WIDTH}
  set C_S_AXIL_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_S_AXIL_ADDR_WIDTH"]
  set_property tooltip {Width of S_AXI address bus} ${C_S_AXIL_ADDR_WIDTH}
  set C_S_AXIL_DATA_WIDTH [ipgui::add_param $IPINST -name "C_S_AXIL_DATA_WIDTH" -widget comboBox]
...
proc update_PARAM_VALUE.C_M_AXIL_ADDR_WIDTH { PARAM_VALUE.C_M_AXIL_ADDR_WIDTH } {
	# Procedure called to update C_M_AXIL_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIL_ADDR_WIDTH { PARAM_VALUE.C_M_AXIL_ADDR_WIDTH } {
	# Procedure called to validate C_M_AXIL_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_M_AXIL_DATA_WIDTH { PARAM_VALUE.C_M_AXIL_DATA_WIDTH } {
	# Procedure called to update C_M_AXIL_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIL_DATA_WIDTH { PARAM_VALUE.C_M_AXIL_DATA_WIDTH } {
	# Procedure called to validate C_M_AXIL_DATA_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_M_AXIF_ADDR_WIDTH { PARAM_VALUE.C_M_AXIF_ADDR_WIDTH } {
	# Procedure called to update C_M_AXIF_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIF_ADDR_WIDTH { PARAM_VALUE.C_M_AXIF_ADDR_WIDTH } {
	# Procedure called to validate C_M_AXIF_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_M_AXIF_DATA_WIDTH { PARAM_VALUE.C_M_AXIF_DATA_WIDTH } {
	# Procedure called to update C_M_AXIF_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIF_DATA_WIDTH { PARAM_VALUE.C_M_AXIF_DATA_WIDTH } {
	# Procedure called to validate C_M_AXIF_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_AXIL_ADDR_WIDTH { MODELPARAM_VALUE.C_M_AXIL_ADDR_WIDTH PARAM_VALUE.C_M_AXIL_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIL_ADDR_WIDTH}] ${MODELPARAM_VALUE.C_M_AXIL_ADDR_WIDTH}
}

proc update_MODELPARAM_VALUE.C_M_AXIL_DATA_WIDTH { MODELPARAM_VALUE.C_M_AXIL_DATA_WIDTH PARAM_VALUE.C_M_AXIL_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIL_DATA_WIDTH}] ${MODELPARAM_VALUE.C_M_AXIL_DATA_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_M_AXIF_ADDR_WIDTH { MODELPARAM_VALUE.C_M_AXIF_ADDR_WIDTH PARAM_VALUE.C_M_AXIF_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIF_ADDR_WIDTH}] ${MODELPARAM_VALUE.C_M_AXIF_ADDR_WIDTH}
}

proc update_MODELPARAM_VALUE.C_M_AXIF_DATA_WIDTH { MODELPARAM_VALUE.C_M_AXIF_DATA_WIDTH PARAM_VALUE.C_M_AXIF_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIF_DATA_WIDTH}] ${MODELPARAM_VALUE.C_M_AXIF_DATA_WIDTH}
}
