...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AXI4_Slaves_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI4_Slaves_0/S_AXIL]
	connect_bd_net [get_bd_pins AXI4_Slaves_0/s_axil_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Slaves_0/s_axil_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins AXI4_Slaves_0/S_AXIF]
	connect_bd_net [get_bd_pins AXI4_Slaves_0/s_axif_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI4_Slaves_0/s_axif_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AXI4_Slaves_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI4_Slaves_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI4_Slaves_0_S_AXIF_* ]]
	puts $fp "set s_axif_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI4_Slaves_0_S_AXIL_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AXI4_Slaves:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI4_Slaves_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI4_Slaves_v1_0_hw_${i}"
