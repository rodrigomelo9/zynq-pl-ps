...
proc init_gui { IPINST } {
  ...
  set C_AXIS_TDATA_WIDTH [ipgui::add_param $IPINST -name "C_AXIS_TDATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of S_AXIS address bus. The slave accepts the read and write addresses of width C_M_AXIS_TDATA_WIDTH.} ${C_AXIS_TDATA_WIDTH}
  set C_AXIS_START_COUNT [ipgui::add_param $IPINST -name "C_AXIS_START_COUNT" -parent ${Page_0}]
  set_property tooltip {Start count is the number of clock cycles the master will wait before initiating/issuing any transaction.} ${C_AXIS_START_COUNT}
  set C_AXIL_DATA_WIDTH [ipgui::add_param $IPINST -name "C_AXIL_DATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of S_AXI data bus} ${C_AXIL_DATA_WIDTH}
  set C_AXIL_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_AXIL_ADDR_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of S_AXI address bus} ${C_AXIL_ADDR_WIDTH}
  ipgui::add_param $IPINST -name "C_AXIL_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_AXIL_HIGHADDR" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_AXIS_START_COUNT { PARAM_VALUE.C_AXIS_START_COUNT } {
	# Procedure called to update C_AXIS_START_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXIS_START_COUNT { PARAM_VALUE.C_AXIS_START_COUNT } {
	# Procedure called to validate C_AXIS_START_COUNT
	return true
}
...
proc update_MODELPARAM_VALUE.C_AXIS_START_COUNT { MODELPARAM_VALUE.C_AXIS_START_COUNT PARAM_VALUE.C_AXIS_START_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_AXIS_START_COUNT}] ${MODELPARAM_VALUE.C_AXIS_START_COUNT}
}
